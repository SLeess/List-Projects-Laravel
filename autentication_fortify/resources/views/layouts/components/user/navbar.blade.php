<nav class="bg-white dark:bg-gray-900 w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
    ...
    <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
        <img class="h-10" src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('img\logo_cead_bg.png'))) }}" alt="Unimontes logo">
        <span class="self-center text-2xl whitespace-nowrap text-[#333A56] font-bold dark:text-white">{{ Env('APP_NAME') }}</span>
    </a>
    <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        ...
        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
          ...
          <ul class="py-2" aria-labelledby="user-menu-button">
            ...
            <li>
              <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Treinamentos</a>
            </li>
            <li>
